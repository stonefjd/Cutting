...
//--系统状态变量与子状态变量
    ...
    SubStateOprt m_stSubOprt = stSubOprt_NotIn;
//--机头传入参数
...
public:
    explicit CtrlMach(QObject *parent = nullptr);
...
//--外部写入辅助变量
    void KeyActionEvent(QKeyEvent event);
//--系统状态读
